...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $nilaiAkhir = 0;
    if ($umurPengguna < 25) {
        $nilaiAkhir = isset($nilaiSitUp1Pria['under_25'][$jumlahSitUp1Pria]) ? $nilaiSitUp1Pria['under_25'][$jumlahSitUp1Pria] : 0;
    } elseif ($umurPengguna >= 25 && $umurPengguna <= 34) {
        $nilaiAkhir = isset($nilaiSitUp1Pria['25-34'][$jumlahSitUp1Pria]) ? $nilaiSitUp1Pria['25-34'][$jumlahSitUp1Pria] : 0;
    } elseif ($umurPengguna >= 35 && $umurPengguna <= 44) {
        $nilaiAkhir = isset($nilaiSitUp1Pria['35-44'][$jumlahSitUp1Pria]) ? $nilaiSitUp1Pria['35-44'][$jumlahSitUp1Pria] : 0;
    } elseif ($umurPengguna >= 45 && $umurPengguna <= 54) {
        $nilaiAkhir = isset($nilaiSitUp1Pria['45-54'][$jumlahSitUp1Pria]) ? $nilaiSitUp1Pria['45-54'][$jumlahSitUp1Pria] : 0;
    } elseif ($umurPengguna >= 55 && $umurPengguna <= 59) {
        $nilaiAkhir = isset($nilaiSitUp1Pria['55-59'][$jumlahSitUp1Pria]) ? $nilaiSitUp1Pria['55-59'][$jumlahSitUp1Pria] : 0;
    }

    $dataLamaGarjasPriaSitUp1 = $garjasSitUp1PriaModel->ambilDataGarjasSitUp1OlehId($idGarjasPriaSitUp1);
    
    if ($dataLamaGarjasPriaSitUp1) {
        $dataGarjasPriaSitUp1 = array(
