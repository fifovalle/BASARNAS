...
if (isset($_POST['tambah_nilai'])) {
    ...
    $jumlahShuttleRunWanita = str_replace(',', '.', $jumlahShuttleRunWanita);
    $jumlahShuttleRunWanita = (float) $jumlahShuttleRunWanita;
    ...
    $nilaiShuttleRun = [
        'under_25' => [
            17 => 100, 17.3 => 99, 17.4 => 98, 17.5 => 97, 17.6 => 96,
    ...
    $nilaiAkhir = 0;
    $maksimalShuttleRun = 0;

    if ($umurPengguna < 25) {
        $maksimalShuttleRun = max(array_keys($nilaiShuttleRun['under_25']));
        $nilaiAkhir = $jumlahShuttleRunWanita > $maksimalShuttleRun ? 100 : (isset($nilaiShuttleRun['under_25'][$jumlahShuttleRunWanita]) ? $nilaiShuttleRun['under_25'][$jumlahShuttleRunWanita] : 0);
    } elseif ($umurPengguna >= 25 && $umurPengguna <= 34) {
        $maksimalShuttleRun = max(array_keys($nilaiShuttleRun['25-34']));
        $nilaiAkhir = $jumlahShuttleRunWanita > $maksimalShuttleRun ? 100 : (isset($nilaiShuttleRun['25-34'][$jumlahShuttleRunWanita]) ? $nilaiShuttleRun['25-34'][$jumlahShuttleRunWanita] : 0);
    } elseif ($umurPengguna >= 35 && $umurPengguna <= 44) {
        $maksimalShuttleRun = max(array_keys($nilaiShuttleRun['35-44']));
        $nilaiAkhir = $jumlahShuttleRunWanita > $maksimalShuttleRun ? 100 : (isset($nilaiShuttleRun['35-44'][$jumlahShuttleRunWanita]) ? $nilaiShuttleRun['35-44'][$jumlahShuttleRunWanita] : 0);
    } elseif ($umurPengguna >= 45 && $umurPengguna <= 54) {
        $maksimalShuttleRun = max(array_keys($nilaiShuttleRun['45-54']));
        $nilaiAkhir = $jumlahShuttleRunWanita > $maksimalShuttleRun ? 100 : (isset($nilaiShuttleRun['45-54'][$jumlahShuttleRunWanita]) ? $nilaiShuttleRun['45-54'][$jumlahShuttleRunWanita] : 0);
    } elseif ($umurPengguna >= 55 && $umurPengguna <= 59) {
        $maksimalShuttleRun = max(array_keys($nilaiShuttleRun['55-59']));
        $nilaiAkhir = $jumlahShuttleRunWanita > $maksimalShuttleRun ? 100 : (isset($nilaiShuttleRun['55-59'][$jumlahShuttleRunWanita]) ? $nilaiShuttleRun['55-59'][$jumlahShuttleRunWanita] : 0);
    } else {
        $maksimalShuttleRun = max(array_keys($nilaiShuttleRun['under_25']));
        $nilaiAkhir = $jumlahShuttleRunWanita > $maksimalShuttleRun ? 100 : (isset($nilaiShuttleRun['under_25'][$jumlahShuttleRunWanita]) ? $nilaiShuttleRun['under_25'][$jumlahShuttleRunWanita] : 0);
    }
