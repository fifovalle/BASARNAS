...
if (isset($_POST['Simpan'])) {
    ...
    $jumlahChinUp = mysqli_real_escape_string($koneksi, $_POST['Jumlah_Chin_Up']);
    $tanggalPelaksanaanChinUp = mysqli_real_escape_string($koneksi, $_POST['Tanggal_Pelaksanaan_Chin_Up']);
    ...
    if ($cekKelaminPengguna == "Pria") {
        ...
        if ($umurPengguna < 25) {
            $nilaiAkhir = isset($nilaiChinUp['under_25'][$jumlahChinUp]) ? $nilaiChinUp['under_25'][$jumlahChinUp] : 0;
            if ($jumlahChinUp > 20 && isset($nilaiChinUp['under_25']['>20'])) {
                $nilaiAkhir = $nilaiChinUp['under_25']['>20'];
            }
        } elseif ($umurPengguna >= 25 && $umurPengguna <= 34) {
            $nilaiAkhir = isset($nilaiChinUp['25-34'][$jumlahChinUp]) ? $nilaiChinUp['25-34'][$jumlahChinUp] : 0;
            if ($jumlahChinUp > 18 && isset($nilaiChinUp['25-34']['>18'])) {
                $nilaiAkhir = $nilaiChinUp['25-34']['>18'];
            }
        } elseif ($umurPengguna >= 35 && $umurPengguna <= 44) {
            $nilaiAkhir = isset($nilaiChinUp['35-44'][$jumlahChinUp]) ? $nilaiChinUp['35-44'][$jumlahChinUp] : 0;
            if ($jumlahChinUp > 16 && isset($nilaiChinUp['35-44']['>16'])) {
                $nilaiAkhir = $nilaiChinUp['35-44']['>16'];
            }
        } elseif ($umurPengguna >= 45 && $umurPengguna <= 54) {
            $nilaiAkhir = isset($nilaiChinUp['45-54'][$jumlahChinUp]) ? $nilaiChinUp['45-54'][$jumlahChinUp] : 0;
            if ($jumlahChinUp > 14 && isset($nilaiChinUp['45-54']['>14'])) {
                $nilaiAkhir = $nilaiChinUp['45-54']['>14'];
            }
        } elseif ($umurPengguna >= 55 && $umurPengguna <= 59) {
            $nilaiAkhir = isset($nilaiChinUp['55-59'][$jumlahChinUp]) ? $nilaiChinUp['55-59'][$jumlahChinUp] : 0;
            if ($jumlahChinUp > 11 && isset($nilaiChinUp['55-59']['>11'])) {
        ...
        $dataPengguna = array(
            ...
            'Tanggal_Pelaksanaan_Chin_Up_Pria' => $tanggalPelaksanaanChinUp,
            'Jumlah_Chin_Up_Pria' => $jumlahChinUp,
            'Nilai_Chin_Up_Pria' => $nilaiAkhir,
            "Status_Pria_Chin_Up" => "Ditinjau"
        );

        if ($obyekGarjasPriaChinUp->cekNipAnggotaChinUpPriaSudahAda($nipPengguna)) {
            $updateGarjasPriaTesChinUP = $obyekGarjasPriaChinUp->perbaruiGarjasPriaChinUpJikaDitolak($nipPengguna, $dataPengguna);
        } else {
        ...
        if (empty($nipPengguna) && empty($tanggalPelaksanaanChinUp) && empty($jumlahChinUp)) {
            $pesanKesalahan = "Semua bidang harus diisi. ";
        } elseif (empty($nipPengguna)) {
            $pesanKesalahan = "NIP Pengguna harus diisi. ";
        } elseif (empty($tanggalPelaksanaanChinUp)) {
        ...
        if ($umurPengguna < 25) {
            ...
            $nilaiAkhir = $jumlahChinUp > $maksimalChinUp ? 100 : (isset($nilaiChinUp['under_25'][$jumlahChinUp]) ? $nilaiChinUp['under_25'][$jumlahChinUp] : 0);
        } elseif ($umurPengguna >= 25 && $umurPengguna <= 34) {
            $maksimalChinUp = max(array_keys($nilaiChinUp['25-34']));
            $nilaiAkhir = $jumlahChinUp > $maksimalChinUp ? 100 : (isset($nilaiChinUp['25-34'][$jumlahChinUp]) ? $nilaiChinUp['25-34'][$jumlahChinUp] : 0);
        } elseif ($umurPengguna >= 35 && $umurPengguna <= 44) {
            $maksimalChinUp = max(array_keys($nilaiChinUp['35-44']));
            $nilaiAkhir = $jumlahChinUp > $maksimalChinUp ? 100 : (isset($nilaiChinUp['35-44'][$jumlahChinUp]) ? $nilaiChinUp['35-44'][$jumlahChinUp] : 0);
        } elseif ($umurPengguna >= 45 && $umurPengguna <= 54) {
            $maksimalChinUp = max(array_keys($nilaiChinUp['45-54']));
            $nilaiAkhir = $jumlahChinUp > $maksimalChinUp ? 100 : (isset($nilaiChinUp['45-54'][$jumlahChinUp]) ? $nilaiChinUp['45-54'][$jumlahChinUp] : 0);
        } elseif ($umurPengguna >= 55 && $umurPengguna <= 59) {
            $maksimalChinUp = max(array_keys($nilaiChinUp['55-59']));
            $nilaiAkhir = $jumlahChinUp > $maksimalChinUp ? 100 : (isset($nilaiChinUp['55-59'][$jumlahChinUp]) ? $nilaiChinUp['55-59'][$jumlahChinUp] : 0);
        }

        $dataPenggunaWanita = array(
            'NIP_Pengguna' => $nipPengguna,
            'Tanggal_Pelaksanaan_Chin_Up_Wanita' => $tanggalPelaksanaanChinUp,
            'Jumlah_Chin_Up_Wanita' => $jumlahChinUp,
            'Nilai_Chin_Up_Wanita' => $nilaiAkhir,
            "Status_Wanita_Chin_Up" => "Ditinjau"
        );
        if ($obyekPenggunaWanita->cekNipAnggotaChinUpWanitaSudahAda($nipPengguna)) {
            $updateGarjasWanitaTesChinUP = $obyekPenggunaWanita->perbaruiGarjasWanitaChinUpJikaDitolak($nipPengguna, $dataPenggunaWanita);
        } else {
            $simpanDataPenggunaWanita = $obyekPenggunaWanita->tambahGarjasWanitaChinUp($dataPenggunaWanita);
        }
    }

    if ($simpanDataPengguna || $updateGarjasPriaTesChinUP || $updateGarjasWanitaTesChinUP || $simpanDataPenggunaWanita) {
