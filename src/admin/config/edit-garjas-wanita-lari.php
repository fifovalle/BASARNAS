...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $nilaiAkhir = 0;
    if ($umurPengguna < 25) {
        $nilaiAkhir = isset($nilaiTesLari['under_25'][$waktuTestLariWanita]) ? $nilaiTesLari['under_25'][$waktuTestLariWanita] : 0;
    } elseif ($umurPengguna >= 25 && $umurPengguna <= 34) {
        $nilaiAkhir = isset($nilaiTesLari['25-34'][$waktuTestLariWanita]) ? $nilaiTesLari['25-34'][$waktuTestLariWanita] : 0;
    } elseif ($umurPengguna >= 35 && $umurPengguna <= 44) {
        $nilaiAkhir = isset($nilaiTesLari['35-44'][$waktuTestLariWanita]) ? $nilaiTesLari['35-44'][$waktuTestLariWanita] : 0;
    } elseif ($umurPengguna >= 45 && $umurPengguna <= 54) {
        $nilaiAkhir = isset($nilaiTesLari['45-54'][$waktuTestLariWanita]) ? $nilaiTesLari['45-54'][$waktuTestLariWanita] : 0;
    } elseif ($umurPengguna >= 55 && $umurPengguna <= 59) {
        $nilaiAkhir = isset($nilaiTesLari['55-59'][$waktuTestLariWanita]) ? $nilaiTesLari['55-59'][$waktuTestLariWanita] : 0;
    }
