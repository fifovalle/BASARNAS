...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $nilaiAkhir = 0;
    if ($umurPengguna < 25) {
        $nilaiAkhir = isset($nilaiTesLari['under_25'][$waktuTestLariPria]) ? $nilaiTesLari['under_25'][$waktuTestLariPria] : 0;
    } elseif ($umurPengguna >= 25 && $umurPengguna <= 34) {
        $nilaiAkhir = isset($nilaiTesLari['25-34'][$waktuTestLariPria]) ? $nilaiTesLari['25-34'][$waktuTestLariPria] : 0;
    } elseif ($umurPengguna >= 35 && $umurPengguna <= 44) {
        $nilaiAkhir = isset($nilaiTesLari['35-44'][$waktuTestLariPria]) ? $nilaiTesLari['35-44'][$waktuTestLariPria] : 0;
    } elseif ($umurPengguna >= 45 && $umurPengguna <= 54) {
        $nilaiAkhir = isset($nilaiTesLari['45-54'][$waktuTestLariPria]) ? $nilaiTesLari['45-54'][$waktuTestLariPria] : 0;
    } elseif ($umurPengguna >= 55 && $umurPengguna <= 59) {
        $nilaiAkhir = isset($nilaiTesLari['55-59'][$waktuTestLariPria]) ? $nilaiTesLari['55-59'][$waktuTestLariPria] : 0;
    }
