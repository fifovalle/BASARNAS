...
if (isset($_POST['Simpan'])) {
    ...
    $obyekPengguna = new GarjasPushUpPria($koneksi);
    ...
    $tanggal_pelaksanaan_pushup_pria = DateTime::createFromFormat('Y-m-d', $tanggalPelaksanaanPushUpPria);

    if ($tanggal_pelaksanaan_pushup_pria === false) {
        $pesanKesalahan .= "Format tanggal pelaksanaan tidak valid. ";
    } else {
        $tanggal_pelaksanaan_database = $tanggal_pelaksanaan_pushup_pria->format('Y-m-d');
    }
