...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $statusWanitaSitUp1 = $_POST['Status_Wanita_Sit_Up_Kaki_Lurus'] ?? '';
    ...
    if ($jumlahSitUp1Wanita < 0) {
        echo json_encode(array("success" => false, "message" => "Jumlah sit-up tidak boleh negatif."));
        exit;
    }
    ...
    $dataGarjasWanitaSitUp1 = array(
        ...
        "Status_Wanita_Sit_Up_Kaki_Lurus" => $statusWanitaSitUp1
    );
