...
if (isset($_POST['tambah_nilai'])) {
    ...
    $waktuJalanPria = mysqli_real_escape_string($koneksi, $_POST['Waktu_Jalan']);
    ...
    $waktuJalanPria = str_replace(',', '.', $waktuJalanPria);
    $waktuJalanPria = (float) $waktuJalanPria;
    ...
    if ($umurPengguna < 25) {
        if ($waktuJalanPria < 9.0) {
            $nilaiAkhir = 100;
        } elseif ($waktuJalanPria > 23.5) {
            $nilaiAkhir = 1;
        } else {
