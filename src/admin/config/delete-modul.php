...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    ...
    $hapusData = $modulModel->hapusModul($id);

    $successMessage = htmlspecialchars("Data modul berhasil dihapus.");
    $failureMessage = htmlspecialchars("Gagal menghapus data modul.");
