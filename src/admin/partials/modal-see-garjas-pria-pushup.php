<div class="modal fade" id="lihatGarjasPriaPushUp" tabindex="-1" aria-labelledby="lihatGarjasPriaPushUpLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="lihatGarjasPriaPushUpLabel">Info Garjas Pria (Push Up)</h1>
                    ...
                    <div class="col-8">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td id="lihatJumalahPushUpPriaGP"></td>
                            </tr>
                            <tr>
                                <th>Nilai Push Up:</th>
                                <td id="lihatNilaiPushUpPriaGP"></td>
                            </tr>
                        </table>
