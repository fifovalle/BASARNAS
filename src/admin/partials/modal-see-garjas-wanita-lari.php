<div class="modal fade" id="lihatGarjasWanitaLari" tabindex="-1" aria-labelledby="lihatGarjasWanitaLariLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="lihatGarjasWanitaLariLabel">Info Garjas Wanita (Lari 2400 M)</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <th>Waktu Lari:</th>
                                <td id="lihatWaktuTesLariWanitaGW"></td>
                            </tr>
                            <tr>
                                <th>Nilai Lari:</th>
                                <td id="lihatNilaiTesLariWanitaGW"></td>
                            </tr>
                            <tr>
