        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../config/" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="suntingWaktuJalanAdmin" class="form-label">Waktu Jalan</label>
                        <input type="number" class="form-control" id="suntingWaktuJalanAdmin" name="Nomor_Telepon_Admin">
                    </div>
