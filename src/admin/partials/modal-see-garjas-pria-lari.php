<div class="modal fade" id="lihatGarjasPriaLari" tabindex="-1" aria-labelledby="lihatGarjasPriaLariLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="lihatGarjasPriaLariLabel">Info Garjas Pria (Lari 2400 M)</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <th>Waktu Lari:</th>
                                <td id="lihatWaktuTesLariPriaTd"></td>
                            </tr>
                            <tr>
                                <th>Nilai Lari:</th>
