        ...
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="garjasPria">
                        <ul class="nav nav-collapse">
                            <li>
                            ...
                            <li>
                                <a href="components/panels.html">
                                    <span class="sub-item">Chain Up</span>
                                </a>
                            </li>
                            <li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="garjasWanita">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="components/buttons.html">
                                    <span class="sub-item">Push Up</span>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tesRenang">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="components/buttons.html">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tesJalan">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="components/buttons.html">
                                    <span class="sub-item">Pria</span>
