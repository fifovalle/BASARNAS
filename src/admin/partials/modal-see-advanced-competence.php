<div class="modal fade" id="lihatKompetensiMahir" tabindex="-1" aria-labelledby="lihatKompetensiMahirLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="lihatKompetensiMahirLabel">Info Kompetensi Mahir</h1>
