<div class="modal fade" id="tambahKompetensiMahir" tabindex="-1" aria-labelledby="tambahKompetensiMahirLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="tambahKompetensiMahirLabel">Tambah Kompetensi Mahir</h1>
