<div class="modal fade" id="tambahKompetensiPenyelia" tabindex="-1" aria-labelledby="tambahKompetensiPenyeliaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="tambahKompetensiPenyeliaLabel">Tambah Kompetensi Penyelia</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="../config/add-investigation-competence.php" method="post" enctype="multipart/form-data">
                    <?php
                    $penggunaModel = new Pengguna($koneksi);
                    $penggunaInfo = $penggunaModel->tampilkanDataPenggunaPenyelia();
                    ?>
                    <div class="mb-3">
