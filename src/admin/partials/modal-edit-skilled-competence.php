<div class="modal fade" id="suntingKompetensiTerampil" tabindex="-1" aria-labelledby="suntingKompetensiTerampilLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="suntingKompetensiTerampilLabel">Sunting Kompetensi Terampil</h1>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <button type="submit" class="btn btn-primary" id="tombolSuntingTerampil">Simpan</button>
                </form>
            </div>
        </div>
    </div>
