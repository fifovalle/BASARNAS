        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        <label for="suntingStatusPushUpGarjasPria" class="form-label">Status</label>
                        <select name="Status_Pria_Push_Up" class="form-control" id="suntingStatusPushUpGarjasPria">
