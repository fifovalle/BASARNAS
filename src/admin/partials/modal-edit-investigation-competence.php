<div class="modal fade" id="suntingKompetensiPenyelia" tabindex="-1" aria-labelledby="suntingKompetensiPenyeliaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="suntingKompetensiPenyeliaLabel">Sunting Kompetensi Penyelia</h1>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <button type="submit" class="btn btn-primary" id="tombolSuntingPenyelia">Simpan</button>
                </form>
            </div>
        </div>
    </div>
