<div class="modal fade" id="lihatGarjasWanitaJalan" tabindex="-1" aria-labelledby="lihatGarjasWanitaJalanLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="lihatGarjasWanitaJalanLabel">Info Garjas Wanita (Jalan Kaki 5 KM)</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <th>Waktu Jalan:</th>
                                <td id="lihatWaktuTesJalanWanitaGW"></td>
                            </tr>
                            <tr>
                                <th>Nilai Jalan:</th>
                                <td id="lihatNilaiTesJalanWanitaGW"></td>
                            </tr>
                        </table>
                    </div>
                </div>
