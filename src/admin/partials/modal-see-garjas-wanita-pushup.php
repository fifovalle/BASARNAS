<div class="modal fade" id="lihatGarjasWanitaPushUp" tabindex="-1" aria-labelledby="lihatGarjasWanitaPushUpLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="lihatGarjasWanitaPushUpLabel">Info Garjas Wanita (Push Up)</h1>
                    ...
                    <div class="col-8">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td id="lihatJumlahPushUpWanitaGW"></td>
                            </tr>
                            <tr>
                                <th>Nilai Push Up:</th>
                                <td id="lihatNilaiPushUpWanitaGW"></td>
                            </tr>
                            <tr>
                                <th>Tanggal Pelaksanaan:</th>
                                <td id="tanggalPelaksanaanPushUpWanitaGW"></td>
                            </tr>
                            <tr>
                                <th>Status:</th>
                                <td id="statusPushUpWanitaGW"></td>
                            </tr>
                        </table>
                    </div>
                </div>
