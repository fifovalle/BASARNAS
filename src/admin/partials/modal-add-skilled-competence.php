<div class="modal fade" id="tambahKompetensiTerampil" tabindex="-1" aria-labelledby="tambahKompetensiTerampilLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="tambahKompetensiTerampilLabel">Tambah Kompetensi Terampil</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="../config/add-skilled-competence.php" method="post" enctype="multipart/form-data">
                    <?php
                    $penggunaModel = new Pengguna($koneksi);
                    $penggunaInfo = $penggunaModel->tampilkanDataPenggunaTerampil();
                    ?>
                    <div class="mb-3">
