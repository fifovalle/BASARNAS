    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (garjasPriaPushUpData.success === false) {
          ...
          $("#tanggalPelaksanaanPushUpPriaTd").text(
          ...
          const statusText = garjasPriaPushUpData.Status_Pria_Push_Up;
          const statusClass = statusClasses[statusText] || "";

          $("#statusPushUpPriaTd").text(statusText);
          $("#statusPushUpPriaTd").attr("class", statusClass);
