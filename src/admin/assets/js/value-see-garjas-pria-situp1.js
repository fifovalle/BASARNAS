    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (garjasSitUp1Data.success === false) {
          ...
          $("#lihatFotoPenggunaSitUp1").attr("src", "../uploads/" + garjasSitUp1Data.Foto_Pengguna);
          $("#lihatNamaLengkapSitUp1").text(garjasSitUp1Data.Nama_Lengkap_Pengguna);
          $("#lihatTanggalLahirSitUp1").text(garjasSitUp1Data.Tanggal_Lahir_Pengguna);
          $("#lihatJabatanSitUp1").text(garjasSitUp1Data.Jabatan_Pengguna);
          $("#lihatJenisKelaminSitUp1").text(garjasSitUp1Data.Jenis_Kelamin_Pengguna);
          $("#lihatNoTeleponSitUp1").text(garjasSitUp1Data.No_Telepon_Pengguna);
          $("#lihatUmurSitUp1").text(garjasSitUp1Data.Umur_Pengguna);
          $("#lihatJumlahSitUp1").text(garjasSitUp1Data.Jumlah_Sit_up_Kaki_lurus_Pria);
          $("#lihatNilaiSitUp1").text(garjasSitUp1Data.Nilai_Sit_Up_Kaki_Lurus_Pria);
