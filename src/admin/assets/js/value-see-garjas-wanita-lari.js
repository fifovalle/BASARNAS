    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (penggunaData.success === false) {
          ...
          $("#tanggalPelaksanaanTesLariWanitaGW").text(
            penggunaData.Tanggal_Pelaksanaan_Tes_Lari_Wanita
          );
          const statusClasses = {
          ...
          const statusText = penggunaData.Status_Lari_Wanita;
          const statusClass = statusClasses[statusText] || "";

          $("#statusTesLariWanitaGW").text(statusText);
          $("#statusTesLariWanitaGW").attr("class", statusClass);
