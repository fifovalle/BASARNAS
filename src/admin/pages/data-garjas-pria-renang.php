...
<body>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Data Nilai Garjas Pria (Renang)</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table id="add-row" class="display table table-hover">
                                            ...
                                            <tbody>
                                                <?php if (!empty($tesRenangPriaInfo)) : ?>
                                                    ...
                                                    <?php foreach ($tesRenangPriaInfo as $tesRenangPria) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $tesRenangPria['Tanggal_Pelaksanaan_Tes_Renang_Pria']; ?></td>
                                                ...
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="9" class="text-center text-danger fw-bolder">Tidak ada data Tes Renang Pria!</td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
                                        </table>
    ...
    <script src="../assets/js/laporan-bulanan-pria-renang.js"></script>
    <script>
