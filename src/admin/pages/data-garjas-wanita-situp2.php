...
<body>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Data Nilai Garjas Wanita (Sit Up Kaki Ditekuk)</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table id="add-row" class="display table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="8" class="text-center text-danger fw-bolder">Tidak ada data Sit Up Kaki Di Tekuk yang ditemukan.</td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
                                        </table>
    ...
    <script src="../assets/js/laporan-bulanan-wanita-situp2.js"></script>
