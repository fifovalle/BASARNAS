...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Data Hasil Garjas Pria (Chin Up)</h3>
                            <h6 class="op-7 mb-2">Selamat Datang Di Halaman Data Hasil Garjas Pria (Chin Up) Basarnas</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Data Garjas Pria (Chin Up)</h4>
                                        <button class="btn btn-primary btn-round ms-auto" data-bs-toggle="modal" data-bs-target="#tambahGarjasPriaChinUp">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="add-row" class="display table table-hover">
                                            ...
                                            $garjasChinUpPriaInfo = $garjasChinUpPriaModel->tampilkanDataGarjasPriaChinUp();
                                            ?>
                                            <tbody>
                                                <?php if (!empty($garjasChinUpPriaInfo)) : ?>
                                                    <?php $nomor = 1; ?>
                                                    <?php foreach ($garjasChinUpPriaInfo as $garjasChinUpPria) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-button-action">
                                                                    ...
                                                                    <button type="button" class="btn btn-link btn-danger" onclick="konfirmasiHapusGarjasPriaChinUp(<?php echo $garjasChinUpPria['ID_Pria_Chin_Up']; ?>)">
                                                                        <i class="fa fa-trash"></i>
                                                                    </button>
                                                                    <button type="button" class="btn btn-link btn-info buttonLihatGarjasPriaChinUp" data-bs-toggle="modal" data-id="<?php echo $garjasChinUpPria['ID_Pria_Chin_Up']; ?>">
                                                                        <i class="fa fa-eye"></i>
                                                                    </button>
                                                                </div>
                                                            </td>
    ...
    <!-- MODALS START -->
    <?php include('../partials/modal-add-garjas-pria-chinup.php'); ?>
    <?php include('../partials/modal-edit-garjas-pria-chinup.php'); ?>
    <?php include('../partials/modal-see-garjas-pria-chinup.php'); ?>
    <!-- MODALS END -->
    ...
    <script src="../assets/js/delete-garjas-pria-chinup.js"></script>
    <script src="../assets/js/value-see-garjas-pria-chin-up.js"></script>
    <script src="../assets/js/value-garjas-pria-chinup.js"></script>
    <script src="../assets/js/laporan-bulanan-pria-chinup.js"></script>
    <script>
