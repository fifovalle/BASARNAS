...
<head>
    ...
    <title>Data Kompetensi Terampil</title>
...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Data Hasil Kompetensi Terampil</h3>
                            <h6 class="op-7 mb-2">Selamat Datang Di Halaman Data Hasil Kompetensi Terampil Basarnas</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Data Sertifikat Terampil</h4>
                                        <button class="btn btn-primary btn-round ms-auto" data-bs-toggle="modal" data-bs-target="#tambahKompetensiTerampil">
    ...
    <!-- MODALS START -->
    <?php include('../partials/modal-add-skilled-competence.php'); ?>
