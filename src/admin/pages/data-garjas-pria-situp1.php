...
<head>
    ...
    <title>Data Garjas Pria (Sit Up Kaki Lurus) Basarnas</title>
...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Data Hasil Garjas Pria (Sit Up Kaki Lurus)</h3>
                            <h6 class="op-7 mb-2">Selamat Datang Di Halaman Data Hasil Garjas Pria (Sit Up Kaki Lurus) Basarnas</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                                                ...
                                                <?php if (!empty($garjasPriaSitUp1Info)) : ?>
                                                    ...
                                                    <?php foreach ($garjasPriaSitUp1Info as $garjasPriaSitUp1) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $garjasPriaSitUp1['Tanggal_Pelaksanaan_Sit_Up_Kaki_Lurus_Pria']; ?></td>
                                                            ...
                                                            <td> <span class="badge bg-<?= $garjasPriaSitUp1['Status_Pria_Sit_Up_Kaki_Lurus'] == "Ditinjau" ? "warning" : ($garjasPriaSitUp1['Status_Pria_Sit_Up_Kaki_Lurus'] == "Diterima" ? "success" : "danger") ?>">
                                                                    <?= $garjasPriaSitUp1['Status_Pria_Sit_Up_Kaki_Lurus'] == "Ditinjau" ? "Ditinjau" : ($garjasPriaSitUp1['Status_Pria_Sit_Up_Kaki_Lurus'] == "Diterima" ? "Diterima" : "Ditolak") ?>
                                                                </span></td>
                                                            <td>
    ...
    <!-- MODALS START -->
    <?php include('../partials/modal-add-garjas-pria-situp1.php'); ?>
    <?php include('../partials/modal-edit-garjas-pria-situp1.php'); ?>
    <?php include('../partials/modal-see-garjas-pria-situp1.php'); ?>
    <!-- MODALS END -->
    ...
    <script src="../assets/js/laporan-bulanan-pria-situp1.js"></script>
    <script>
