...
<head>
    ...
    <title>Data Kompetensi Mahir</title>
...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Data Hasil Kompetensi Mahir</h3>
                            <h6 class="op-7 mb-2">Selamat Datang Di Halaman Data Hasil Kompetensi Mahir Basarnas</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
    ...
    <!-- MODALS START -->
    <?php include('../partials/modal-add-advanced-competence.php'); ?>
    ...
    <script src="../assets/js/value-see-advanced-competence.js"></script>
    <script src="../assets/js/value-advanced-competence.js"></script>
    <script src="../assets/js/delete-advanced-competence.js"></script>
    <script>
