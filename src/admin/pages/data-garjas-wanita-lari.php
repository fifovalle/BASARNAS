...
<head>
    ...
    <title>Data Garjas Wanita (Lari 2400 M) Basarnas</title>
...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Data Hasil Garjas Wanita (Lari 2400 M)</h3>
                            <h6 class="op-7 mb-2">Selamat Datang Di Halaman Data Hasil Garjas Wanita (Lari 2400 M) Basarnas</h6>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="add-row" class="display table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="8" class="text-center text-danger fw-bolder">Tidak ada data Tes Lari Wanita yang ditemukan.</td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
                                        </table>
    ...
    <!-- MODALS START -->
    <?php include('../partials/modal-add-garjas-wanita-lari.php'); ?>
    <?php include('../partials/modal-edit-garjas-wanita-lari.php'); ?>
    <?php include('../partials/modal-see-garjas-wanita-lari.php'); ?>
    <!-- MODALS END -->
